# Dataset utils2 and dataloaders
...
def create_dataloader(path, imgsz, batch_size, stride, opt, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
    ...
    # Use torch.utils2.data.DataLoader() if dataset.properties will update during training else InfiniteDataLoader()
...
def extract_boxes(path='../coco/'):  # from utils2.datasets import *; extract_boxes('../coco128')
...
def autosplit(path='../coco', weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Usage: from utils2.datasets import *; autosplit('../coco')
    Arguments
